...
Vue.use(VueCesium, {
  ...
  accessToken:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIxYjczZTkyZi1kZmYyLTRiNDQtYTY2Mi1lZDA1Mjg2ZjFmYjkiLCJpZCI6MTgzMDEsInNjb3BlcyI6WyJhc3IiLCJnYyJdLCJpYXQiOjE1NzM2MDQ5MDR9.GFlpO_S0iOa5yQuFBlqzU5TfUjVDsFuyqsHbbJTmiRg",
});
export default {};
</script>
