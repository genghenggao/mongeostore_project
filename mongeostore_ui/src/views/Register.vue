<template>
<div id="poster">
    <el-form class="login-container" label-position="left" ref="loginForm" :model="user" label-width="80px">
        ...
        <el-form-item>
            <el-button type="primary" style="width: 100%;background: #505458;border: none" icon @click="doRegister()">注册账号</el-button>
        </el-form-item>
    </el-form>
</div>
</template>
