<template>
  <div style="padding-top: 20px">
    <el-row>
      <el-col :span="18"><h4>上传CSV数据（保存json数据格式）</h4></el-col>
      <el-col :span="6"
        ><el-button ref="VideoChose2" id="VideoChose2" size="medium"
          >选择文件</el-button
        >
        <el-button
          ref="VideoChose2"
...
export default {
  name: "CommonUploadCSV",
  data() {
    return {
      show: false,
      fileList: [],
      fileOptions: {
        browse_button: "VideoChose2",
        // url: "http://127.0.0.1:8000/load/uploadfile/",
        url: "http://127.0.0.1:8000/load/commonuploadcsv/",
  ...
  mounted() {
    ...
    let url = `http://127.0.0.1:8000/load/commonuploadcsv/`;
