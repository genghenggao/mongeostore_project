...
LastEditors: henggao
LastEditTime: 2020-12-16 21:10:50
'''
import math
...
if __name__ == '__main__':
    ...
    x = XY2LatLon(430155.26766,4318431.8336, 111)
    print(x)
    # y1 = LatLon2XY(31.228520,121.4753)
    # y2 = LatLon2XY(339.90712,116.39128)
    # print(y1)
    # print(y2)
    # x = pow((y1[0]-y2[0]),2)+pow((y1[1]-y2[1]),2)
    # x1 = math.sqrt(x)
    # print(x1)
